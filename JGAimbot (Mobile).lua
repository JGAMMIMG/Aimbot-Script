...
local function GetNearestVisibleTarget()
    ...
    for _, player em ipairs(Players:GetPlayers()) do
...
local function ToggleCameraMode()
    ...
    if player.CameraMode == Enum.CameraMode.LockFirstPerson então
