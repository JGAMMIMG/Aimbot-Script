-- Script ainda não foi testado no mobile, então pode ser que não funcione corretamente
...
local function GetNearestVisibleTarget()
	...
	-- Adicionar jogadores à lista de alvos, excluindo o jogador local
...
local function CreateMobileButtons()
	...
	aimButton.Size = UDim2.new(0.1, 0, 0.1, 0) -- Tamanho do botão
	aimButton.Position = UDim2.new(0.85, 0, 0.366, 0) -- Posição ajustada
	aimButton.Text = "Mirar"
	aimButton.BackgroundColor3 = Color3.fromRGB(50, 200, 50) -- Cor do botão
